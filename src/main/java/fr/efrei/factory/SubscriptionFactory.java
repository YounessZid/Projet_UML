...
public class SubscriptionFactory {
    ...
    public static Subscription createSubscription(String name, String duration, int price, String description, Date startDate, Customer customer, int ID_Subscription){
